...
- After the successful installation of `nodejs` and `npm`, clone the repository into your local system using below command:
  - ```python
     git clone https://github.com/alaesahbou/my_portfolio.git
    ```
...
Note here that if you click [my portfolio](https://sahbou.ml), you can see the logo at the beginning. 
...
- Some Design and Implementation Ideas are taken from [rohankokkula](https://github.com/ashutosh1919/masterPortfolio) & [Ashutosh Hathidara's Portfolio Project](https://github.com/ashutosh1919/masterPortfolio) & [Saad Pasta's Portfolio Project](https://github.com/saadpasta/developerFolio)
